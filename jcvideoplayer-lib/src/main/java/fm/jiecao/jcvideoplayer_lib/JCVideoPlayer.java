            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                                ...
                                if (absDeltaX >= THRESHOLD) {
                                    ...
                                    if (mDownX < mScreenWidth * 0.5f) {//左侧改变亮度
                                        ...
                                        if (getContext() instanceof FragmentActivity) {
                                            lp = ((FragmentActivity)getContext()).getWindow().getAttributes();
                                        }else {
                                            lp = JCUtils.getAppCompActivity(getContext()).getWindow().getAttributes();
                                        }
                    ...
                    if (mChangeBrightness) {
                        ...
                        if (getContext() instanceof FragmentActivity) {
                            params = ((FragmentActivity)getContext()).getWindow().getAttributes();
                        }else {
                            params = JCUtils.getAppCompActivity(getContext()).getWindow().getAttributes();
                        }
                        ...
                        if (getContext() instanceof FragmentActivity) {
                            ((FragmentActivity)getContext()).getWindow().setAttributes(params);
                        }else {
...
//            int duration = getDuration();
        ...
        if (getContext() instanceof FragmentActivity) {
            ((FragmentActivity)getContext()).setRequestedOrientation(NORMAL_ORIENTATION);
        }else {
    ...
    public void autoFullscreen(float x) {
        if (isCurrentJcvd()
            ...
            if (x > 0) {
                if (getContext() instanceof FragmentActivity) {
                    ((FragmentActivity)getContext()).setRequestedOrientation(
    ...
    public void startWindowFullscreen() {
        ...
        if (getContext() instanceof FragmentActivity) {
            ((FragmentActivity)getContext()).setRequestedOrientation(FULLSCREEN_ORIENTATION);
        }else {
...
//    }
    ...
    public static void startFullscreen(Context context, Class _class, String url, Object... objects) {
        ...
        if (context instanceof FragmentActivity) {
            ((FragmentActivity)context).setRequestedOrientation(FULLSCREEN_ORIENTATION);
        }
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public static void hideSupportActionBar(Context context) {
        if (ACTION_BAR_EXIST) {
            if (context instanceof FragmentActivity){
               android.app.ActionBar ab = ((FragmentActivity) context).getActionBar();
                if (ab != null) {
                    ab.hide();
                }
            }else {
