...
public class XHorizontalScrollView extends HorizontalScrollView {
	...
	public XHorizontalScrollView(Context context, AttributeSet attrs,
		...
		a = context.obtainStyledAttributes(attrs,
				R.styleable.XHorizontalScrollView);

		indicatorColor = a.getColor(
				R.styleable.XHorizontalScrollView_pstsIndicatorColor,
				indicatorColor);
		underlineColor = a.getColor(
				R.styleable.XHorizontalScrollView_pstsUnderlineColor,
				underlineColor);
		dividerColor = a
				.getColor(R.styleable.XHorizontalScrollView_pstsDividerColor,
						dividerColor);
		indicatorHeight = a.getDimensionPixelSize(
				R.styleable.XHorizontalScrollView_pstsIndicatorHeight,
				indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(
				R.styleable.XHorizontalScrollView_pstsUnderlineHeight,
				underlineHeight);
		dividerPadding = a.getDimensionPixelSize(
				R.styleable.XHorizontalScrollView_pstsDividerPadding,
				dividerPadding);
		tabPadding = a.getDimensionPixelSize(
				R.styleable.XHorizontalScrollView_pstsTabPaddingLeftRight,
				tabPadding);
		tabBackgroundResId = a.getResourceId(
				R.styleable.XHorizontalScrollView_pstsTabBackground,
				tabBackgroundResId);
		shouldExpand = a
				.getBoolean(R.styleable.XHorizontalScrollView_pstsShouldExpand,
						shouldExpand);
		scrollOffset = a
				.getDimensionPixelSize(
						R.styleable.XHorizontalScrollView_pstsScrollOffset,
						scrollOffset);
		textAllCaps = a.getBoolean(
				R.styleable.XHorizontalScrollView_pstsTextAllCaps, textAllCaps);
