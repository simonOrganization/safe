...
public class MultiImageView extends LinearLayout {
     ...
     * 长度 单位为Pixel
     **/
    private int pxOneWidth = CommonUtils.dip2px(getContext(), 115);// 单张图时候的宽
    private int pxOneHeight = CommonUtils.dip2px(getContext(), 150);// 单张图时候的高
    private int pxMoreWandH = 0;// 多张图的宽高
    private int pxImagePadding = CommonUtils.dip2px(getContext(), 10);// 图片间的间距
