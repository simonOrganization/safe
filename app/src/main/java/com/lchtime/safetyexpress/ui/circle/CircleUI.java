...
public class CircleUI extends BaseUI {
    ...
    private void initData(){
        ...
        arrayList.add(new CircleSelectBean(false));
        arrayList.add(new CircleSelectBean(false));
        ArrayList<CircleTwoBean> oneLists = new ArrayList<CircleTwoBean>();
        oneLists.add(new CircleTwoBean());
        ArrayList<CircleTwoBean> twoList = new ArrayList<CircleTwoBean>();
        twoList.add(new CircleTwoBean());
        twoList.add(new CircleTwoBean());
        twoList.add(new CircleTwoBean());
        twoList.add(new CircleTwoBean());
        ArrayList<CircleTwoBean> twoLists = new ArrayList<CircleTwoBean>();
        twoLists.add(new CircleTwoBean());
        twoLists.add(new CircleTwoBean());
        twoLists.add(new CircleTwoBean());
        twoLists.add(new CircleTwoBean());
        twoLists.add(new CircleTwoBean());
