...
public class FindGroupsFragment extends Fragment {
    ...
    private void initData() {
        ...
        if (!TextUtils.isEmpty(mUb_id)) {
            mProtocal.getFriendsCommend(mUb_id, "1", new AddCommandProtocal.NormalListener() {
                @Override
                public void normalResponse(Object response) {
                    if (response == null){
                        ...
                        if (bean.qun != null && bean.qun.size() > 0) {
                            AddFriendsCommendAdapter adapter = new AddFriendsCommendAdapter(FindGroupsFragment.this, bean.qun, 1);
