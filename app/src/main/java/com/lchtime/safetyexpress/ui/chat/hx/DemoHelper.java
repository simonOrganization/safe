...
public class DemoHelper {
    ...
    private void initDbDao() {
        ...
        topUserDao = new TopUserDao(appContext);
    }
...
//        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            ...
            topUserDao.deleteContact(username);
            broadcastManager.sendBroadcast(new Intent(Constant.ACTION_CONTACT_CHANAGED));
        }
...
//        }
    ...
    protected void onUserException(String exception){
        ...
        Intent intent = new Intent(appContext, TabUI.class);
    ...
    private Map<String, EaseUser> topUserList;

    public void setTopUserList(Map<String, EaseUser> topUserList) {
