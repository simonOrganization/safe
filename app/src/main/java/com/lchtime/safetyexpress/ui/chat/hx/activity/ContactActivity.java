        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
				...
				if(action.equals(Constant.ACTION_GROUP_CHANAGED)){
					if (EaseCommonUtils.getTopActivity(ContactActivity.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
					if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
					    ...
					    Toast.makeText(ContactActivity.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
					    .show();
...
//		});
	...
	private void showExceptionDialog(String exceptionType) {
		...
		if (!ContactActivity.this.isFinishing()) {
			...
			try {
				if (exceptionBuilder == null)
				    exceptionBuilder = new android.app.AlertDialog.Builder(ContactActivity.this);
                ...
                DemoHelper.getInstance().logout(false,new EMCallBack() {
                    ...
                    public void onSuccess() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                finish();
                                startActivity(new Intent(ContactActivity.this, LoginUI.class));
                            }
                        });
                    }
