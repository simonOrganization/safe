 ...
 * 视频播放
 */
public class VideoPlayActivity extends Fragment implements View.OnClickListener {
    ...
    private void initView(View view) {
        videoView = (VideoView)view.findViewById(com.dalong.recordlib.R.id.video_play);
        photoPlay = (ImageView)view.findViewById(com.dalong.recordlib.R.id.photo_play);
        videoCancel = (ImageView)view.findViewById(com.dalong.recordlib.R.id.video_cancel);
        videoUse = (ImageView)view.findViewById(com.dalong.recordlib.R.id.video_use);
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == com.dalong.recordlib.R.id.video_use) {
            useVideo();
        } else if (i == com.dalong.recordlib.R.id.video_cancel) {
            onCancel();
        }
    }
