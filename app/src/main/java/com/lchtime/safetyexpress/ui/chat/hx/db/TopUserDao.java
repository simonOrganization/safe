...
public class TopUserDao {
	public static final String TABLE_NAME = "my_top_users";
	...
	public Map<String, EaseUser> getContactList() {
	    ...
	    return DemoDBManager.getInstance().getUPList();
	}
	...
	public void deleteContact(String username){
	    DemoDBManager.getInstance().deleteUp(username);
	}
	...
	public void saveContact(EaseUser user){
	    DemoDBManager.getInstance().saveTop(user);
	}
