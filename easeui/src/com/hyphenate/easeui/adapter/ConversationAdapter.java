...
public class ConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public ConversationAdapter(Context context, int resource,
        ...
        super(context, resource, conversiationList);
        this.userInfo = userInfo;
        this.context = context;
        conversationList = conversiationList;
        this.top_list = top_list;
        this.topUserMap = topUserMap;
        copyConversationList = new ArrayList<EMConversation>();
        copyConversationList.addAll(conversiationList);
    }
...
//        return null;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.list_itease_layout.setBackgroundResource(R.drawable.ease_listitem);
