...
import com.hyphenate.easeui.adapter.ConversationAdapter;
...
//    protected EaseConversationAdapter adapter;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListPrimaryTextColor, getResources().getColor(R.color.title_333));
        secondaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListSecondaryTextColor, getResources().getColor(R.color.title_999));
        timeColor = ta.getColor(R.styleable.EaseConversationList_cvsListTimeTextColor, getResources().getColor(R.color.title_999));
...
//        setAdapter(adapter);
    ...
    private Map<String,ContactBean> userInfo;
    public void init(Context context, List<EMConversation> conversationList, List<EMConversation> top_list, Map<String,EaseUser> topMap,Map<String,ContactBean> userInfo){
        ...
        conversations = conversationList;
//        adapter = new EaseConversationAdapter(context, 0, conversationList);
        adapter = new ConversationAdapter(context,0,conversationList,top_list,topMap,userInfo);
        adapter.setCvsListHelper(conversationListHelper);
        adapter.setPrimaryColor(primaryColor);
        adapter.setPrimarySize(primarySize);
        adapter.setSecondaryColor(secondaryColor);
