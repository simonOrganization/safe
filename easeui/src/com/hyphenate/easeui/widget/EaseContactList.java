...
public class EaseContactList extends RelativeLayout {
     ...
     * init view
     */
    public void init(List<EaseUser> contactList,Map<String,ContactBean> userInfo){
    	this.contactList = contactList;
        adapter = new EaseContactAdapter(context, 0, new ArrayList<EaseUser>(contactList),userInfo);
